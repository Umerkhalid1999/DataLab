...
if __name__ == '__main__':
    ...
    print(f"🧪 Feature Engineering: http://localhost:5002/feature_engineering/fixed")
    print(f"🔧 Force login: http://localhost:5002/force-login")
    print("="*60)
    ...
    print("🐛 Debug Tools:")
    print("  • Debug auth state: http://localhost:5002/debug-auth")
    print("  • Clear all auth: http://localhost:5002/force-login")
    print("="*60 + "\n")
